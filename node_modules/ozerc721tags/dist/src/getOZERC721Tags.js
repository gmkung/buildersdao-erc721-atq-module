...
async function returnTags(chainId, apiKey) {
    ...
    while (isMore) {
        const response = await fetch("https://api.thegraph.com/subgraphs/name/your-subgraph-name/your-subgraph", // Adjust this URL to match your actual subgraph endpoint
        {
            method: "POST",
            headers: {
